...
#ifndef __ARCH_ARM_INCLUDE_AT32F4_IRQ_H
#define __ARCH_ARM_INCLUDE_AT32F4_IRQ_H
...
#define AT32_IRQ_EXINT          (16) /* Vector number of the first external interrupt */

/****************************************************************************
 * Included Files
 ****************************************************************************/

#if 1 //defined(CONFIG_AT32F4_AT32F4XX)
#  include <arch/at32f4/at32f4xx_irq.h>
#else
// #  error "Uknown AT32 chip"
#endif
...
#endif /* __ARCH_ARM_INCLUDE_AT32F4_IRQ_H */
